...
public class AspectualacmeVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		if (view instanceof Diagram) {
			if (componentRepresentationaspectualacme.diagram.edit.parts.FreeformLayerEditPart.MODEL_ID
					.equals(view.getType())) {
				return componentRepresentationaspectualacme.diagram.edit.parts.FreeformLayerEditPart.VISUAL_ID;
			} else {
				return -1;
			}
		}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		if (componentRepresentationaspectualacme.diagram.edit.parts.FreeformLayerEditPart.MODEL_ID
			...
			if (containerView instanceof Diagram) {
				containerVisualID = componentRepresentationaspectualacme.diagram.edit.parts.FreeformLayerEditPart.VISUAL_ID;
			} else {
				return -1;
			}
		}
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case componentRepresentationaspectualacme.diagram.edit.parts.SystemEditPart.VISUAL_ID:
			...
			if (componentRepresentationaspectualacme.diagram.edit.parts.SystemRepSystemCompEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case componentRepresentationaspectualacme.diagram.edit.parts.Component2EditPart.VISUAL_ID:
		...
		case componentRepresentationaspectualacme.diagram.edit.parts.ComponentEditPart.VISUAL_ID:
			...
			if (componentRepresentationaspectualacme.diagram.edit.parts.RepresentationEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case componentRepresentationaspectualacme.diagram.edit.parts.ConnectorEditPart.VISUAL_ID:
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (AspectualacmePackage.eINSTANCE.getBinding().isSuperTypeOf(
				domainElement.eClass())) {
