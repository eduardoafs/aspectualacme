 ...
 * @generated
 */
public class AspectualacmeInitDiagramFileAction implements
	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							componentRepresentationaspectualacme.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
							componentRepresentationaspectualacme.diagram.part.Messages.InitDiagramFile_ResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new componentRepresentationaspectualacme.diagram.part.AspectualacmeNewDiagramFileWizard(
