...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private componentRepresentationaspectualacme.diagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new componentRepresentationaspectualacme.diagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
