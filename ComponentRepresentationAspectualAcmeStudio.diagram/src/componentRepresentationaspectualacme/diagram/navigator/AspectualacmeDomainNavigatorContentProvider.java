 ...
 * @generated
 */
public class AspectualacmeDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public AspectualacmeDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof componentRepresentationaspectualacme.diagram.navigator.AspectualacmeDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((componentRepresentationaspectualacme.diagram.navigator.AspectualacmeDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new componentRepresentationaspectualacme.diagram.navigator.AspectualacmeDomainNavigatorItem(
