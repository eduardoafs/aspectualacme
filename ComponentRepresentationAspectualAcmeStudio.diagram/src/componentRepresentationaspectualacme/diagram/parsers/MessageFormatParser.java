...
public class MessageFormatParser extends
		componentRepresentationaspectualacme.diagram.parsers.AbstractParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable adapter,
		...
		if (values == null) {
			return new ParserEditStatus(
					...
					NLS.bind(
							componentRepresentationaspectualacme.diagram.part.Messages.MessageFormatParser_InvalidInputError,
