...
public class ConnectorCompartmentGlueCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<componentRepresentationaspectualacme.diagram.part.AspectualacmeNodeDescriptor> childDescriptors = componentRepresentationaspectualacme.diagram.part.AspectualacmeDiagramUpdater
				.getConnectorCompartmentGlue_7002SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return componentRepresentationaspectualacme.diagram.edit.parts.GlueEditPart.VISUAL_ID == componentRepresentationaspectualacme.diagram.part.AspectualacmeVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<componentRepresentationaspectualacme.diagram.part.AspectualacmeNodeDescriptor> childDescriptors = componentRepresentationaspectualacme.diagram.part.AspectualacmeDiagramUpdater
				.getConnectorCompartmentGlue_7002SemanticChildren((View) getHost()
						.getModel());
