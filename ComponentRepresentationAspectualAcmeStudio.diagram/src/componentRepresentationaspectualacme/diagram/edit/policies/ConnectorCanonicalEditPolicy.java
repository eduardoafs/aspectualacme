...
public class ConnectorCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<componentRepresentationaspectualacme.diagram.part.AspectualacmeNodeDescriptor> childDescriptors = componentRepresentationaspectualacme.diagram.part.AspectualacmeDiagramUpdater
				.getConnector_3004SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		int visualID = componentRepresentationaspectualacme.diagram.part.AspectualacmeVisualIDRegistry
				.getVisualID(view);
		return visualID == componentRepresentationaspectualacme.diagram.edit.parts.BaseRoleEditPart.VISUAL_ID
				|| visualID == componentRepresentationaspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart.VISUAL_ID
				|| visualID == componentRepresentationaspectualacme.diagram.edit.parts.RoleEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<componentRepresentationaspectualacme.diagram.part.AspectualacmeNodeDescriptor> childDescriptors = componentRepresentationaspectualacme.diagram.part.AspectualacmeDiagramUpdater
				.getConnector_3004SemanticChildren((View) getHost().getModel());
