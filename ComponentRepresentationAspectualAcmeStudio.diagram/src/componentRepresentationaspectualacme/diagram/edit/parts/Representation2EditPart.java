 ...
 * @generated
 */
public class Representation2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Representation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new componentRepresentationaspectualacme.diagram.edit.policies.Representation2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.LAYOUT_ROLE, createLayoutEditPolicy());
		installEditPolicy(
				EditPolicyRoles.OPEN_ROLE,
				new componentRepresentationaspectualacme.diagram.edit.policies.OpenDiagramEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new RepresentationFigure();
	}
	...
	public RepresentationFigure getPrimaryShape() {
		return (RepresentationFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class RepresentationFigure extends
			aspectualacme.figures.RepresentationFigure {
