...
public class ComponentEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new componentRepresentationaspectualacme.diagram.edit.policies.ComponentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new componentRepresentationaspectualacme.diagram.edit.policies.ComponentCanonicalEditPolicy());
