...
public class ConnectorEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new componentRepresentationaspectualacme.diagram.edit.policies.ConnectorItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new componentRepresentationaspectualacme.diagram.edit.policies.ConnectorCanonicalEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.ConnectorNameEditPart) {
			((componentRepresentationaspectualacme.diagram.edit.parts.ConnectorNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureConnectorFigureName());
			return true;
		}
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.BaseRoleEditPart) {
			...
			getBorderedFigure()
					...
					.add(((componentRepresentationaspectualacme.diagram.edit.parts.BaseRoleEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart) {
			...
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((componentRepresentationaspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.RoleEditPart) {
			...
			getBorderedFigure()
					.getBorderItemContainer()
					.add(((componentRepresentationaspectualacme.diagram.edit.parts.RoleEditPart) childEditPart)
							.getFigure(), locator);
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.BaseRoleEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((componentRepresentationaspectualacme.diagram.edit.parts.BaseRoleEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((componentRepresentationaspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof componentRepresentationaspectualacme.diagram.edit.parts.RoleEditPart) {
			getBorderedFigure()
					.getBorderItemContainer()
					.remove(((componentRepresentationaspectualacme.diagram.edit.parts.RoleEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	public class ConnectorFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureConnectorFigureName;
		/**
		 * @generated
		 */
		private Ellipse fFigureGlueCompartment;
		...
		private void createContents() {
			...
			fFigureConnectorFigureName = new WrappingLabel();
			fFigureConnectorFigureName.setText("<...>");

			this.add(fFigureConnectorFigureName);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureConnectorFigureName() {
			return fFigureConnectorFigureName;
		}

		/**
		 * @generated
		 */
		public Ellipse getFigureGlueCompartment() {
			return fFigureGlueCompartment;
		}
