 ...
 * @generated
 */
public abstract class AspectualacmeAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = componentRepresentationaspectualacme.diagram.part.ComponentRepresentationAspectualacmeDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected AspectualacmeAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
