...
/**
 * This is the item provider adapter for a {@link aspectualacme.System} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SystemItemProvider
	...
	public String getText(Object object) {
		String label = ((aspectualacme.System)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.SYSTEM__COMPONENTS,
				 AspectualacmeFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.SYSTEM__CONNECTORS,
				 AspectualacmeFactory.eINSTANCE.createConnector()));

		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.SYSTEM__CONNECTORS,
				 AspectualacmeFactory.eINSTANCE.createAspectualConnector()));

		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.SYSTEM__ATTACHMENTS,
				 AspectualacmeFactory.eINSTANCE.createAttachmentDeclaration()));
