...
/**
 * This is the item provider adapter for a {@link aspectualacme.RoleType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_RoleType_parentType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_RoleType_parentType_feature", "_UI_RoleType_type"),
				 AspectualacmePackage.Literals.ROLE_TYPE__PARENT_TYPE,
				 true,
				 false,
				 true,
				 null,
