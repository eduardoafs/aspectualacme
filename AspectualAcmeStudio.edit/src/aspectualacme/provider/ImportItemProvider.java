...
/**
 * This is the item provider adapter for a {@link aspectualacme.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_fileName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_fileName_feature", "_UI_Import_type"),
				 AspectualacmePackage.Literals.IMPORT__FILE_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Import)object).getFileName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Import.class)) {
			case AspectualacmePackage.IMPORT__FILE_NAME:
