...
/**
 * This is the item provider adapter for a {@link aspectualacme.PropertyType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AspectualacmePackage.Literals.PROPERTY_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addValuesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PropertyType_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PropertyType_values_feature", "_UI_PropertyType_type"),
				 AspectualacmePackage.Literals.PROPERTY_TYPE__VALUES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
