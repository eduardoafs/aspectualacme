...
/**
 * This is the item provider adapter for a {@link aspectualacme.Representation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepresentationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AspectualacmePackage.Literals.REPRESENTATION__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AspectualacmePackage.Literals.REPRESENTATION__SYSTEM);
			childrenFeatures.add(AspectualacmePackage.Literals.REPRESENTATION__BINDINGS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.REPRESENTATION__SYSTEM,
				 AspectualacmeFactory.eINSTANCE.createSystem()));

		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.REPRESENTATION__BINDINGS,
				 AspectualacmeFactory.eINSTANCE.createBinding()));
	}
