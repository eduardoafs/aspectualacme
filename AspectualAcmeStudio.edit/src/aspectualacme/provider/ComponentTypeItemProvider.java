...
/**
 * This is the item provider adapter for a {@link aspectualacme.ComponentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComponentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ComponentType_parentType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ComponentType_parentType_feature", "_UI_ComponentType_type"),
				 AspectualacmePackage.Literals.COMPONENT_TYPE__PARENT_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AspectualacmePackage.Literals.COMPONENT_TYPE__PORT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AspectualacmePackage.Literals.COMPONENT_TYPE__PORT,
				 AspectualacmeFactory.eINSTANCE.createPort()));
	}
