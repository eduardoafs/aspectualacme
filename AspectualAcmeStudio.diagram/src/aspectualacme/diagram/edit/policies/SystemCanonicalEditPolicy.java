...
import aspectualacme.diagram.part.AspectualacmeDiagramUpdater;
import aspectualacme.diagram.part.AspectualacmeLinkDescriptor;
import aspectualacme.diagram.part.AspectualacmeNodeDescriptor;
...
public class SystemCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<AspectualacmeNodeDescriptor> childDescriptors = AspectualacmeDiagramUpdater
				.getSystem_1000SemanticChildren(viewObject);
		for (AspectualacmeNodeDescriptor d : childDescriptors) {
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ConnectorEditPart.VISUAL_ID
				|| visualID == ComponentEditPart.VISUAL_ID
				|| visualID == WildCardEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		for (Iterator<AspectualacmeNodeDescriptor> descriptorsIterator = childDescriptors
				.iterator(); descriptorsIterator.hasNext();) {
			AspectualacmeNodeDescriptor next = descriptorsIterator.next();
			String hint = AspectualacmeVisualIDRegistry.getType(next
					.getVisualID());
		...
		for (AspectualacmeNodeDescriptor next : childDescriptors) {
			String hint = AspectualacmeVisualIDRegistry.getType(next
					.getVisualID());
	...
	private Collection<IAdaptable> refreshConnections() {
		...
		Collection<AspectualacmeLinkDescriptor> linkDescriptors = collectAllLinks(
				getDiagram(), domain2NotationMap);
		Collection existingLinks = new LinkedList(getDiagram().getEdges());
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
				.hasNext();) {
			Edge nextDiagramLink = (Edge) linksIterator.next();
			int diagramLinkVisualID = AspectualacmeVisualIDRegistry
			...
			for (Iterator<AspectualacmeLinkDescriptor> linkDescriptorsIterator = linkDescriptors
					.iterator(); linkDescriptorsIterator.hasNext();) {
				AspectualacmeLinkDescriptor nextLinkDescriptor = linkDescriptorsIterator
						.next();
	 ...
	 * @generated
	 */
	private Collection<AspectualacmeLinkDescriptor> collectAllLinks(View view,
		...
		case SystemEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
		...
		case ConnectorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getConnector_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case WildCardEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getWildCard_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case BaseRoleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getBaseRole_3001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case CrosscuttingRoleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getCrosscuttingRole_3002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case RoleEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getRole_3011ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case PortEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getPort_3005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case RepresentationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(AspectualacmeDiagramUpdater
						.getRepresentation_3010ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection<IAdaptable> createConnections(
			Collection<AspectualacmeLinkDescriptor> linkDescriptors,
			Map<EObject, View> domain2NotationMap) {
		LinkedList<IAdaptable> adapters = new LinkedList<IAdaptable>();
		for (AspectualacmeLinkDescriptor nextLinkDescriptor : linkDescriptors) {
			...
			CreateConnectionViewRequest.ConnectionViewDescriptor descriptor = new CreateConnectionViewRequest.ConnectionViewDescriptor(
					...
					AspectualacmeVisualIDRegistry.getType(nextLinkDescriptor
