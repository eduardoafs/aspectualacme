 ...
 * @generated
 */
public class Attachment5ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Attachment5ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4001(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		System container = (System) getLink().eContainer();
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4001(container, getLink(), source,
						getNewTarget());
	}
