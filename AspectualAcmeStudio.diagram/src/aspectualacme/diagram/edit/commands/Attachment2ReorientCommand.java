 ...
 * @generated
 */
public class Attachment2ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Attachment2ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4004(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		System container = (System) getLink().eContainer();
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4004(container, getLink(), source,
						getNewTarget());
	}
