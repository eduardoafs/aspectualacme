 ...
 * @generated
 */
public class Attachment4ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Attachment4ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4006(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		System container = (System) getLink().eContainer();
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4006(container, getLink(), source,
						getNewTarget());
	}
