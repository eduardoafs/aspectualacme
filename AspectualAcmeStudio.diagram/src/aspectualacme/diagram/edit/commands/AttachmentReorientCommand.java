 ...
 * @generated
 */
public class AttachmentReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AttachmentReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4003(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		System container = (System) getLink().eContainer();
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4003(container, getLink(), source,
						getNewTarget());
	}
