 ...
 * @generated
 */
public class Attachment6ReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public Attachment6ReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4002(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		System container = (System) getLink().eContainer();
		return AspectualacmeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttachment_4002(container, getLink(), source,
						getNewTarget());
	}
