...
public class ConnectorEditPart extends AbstractBorderedShapeEditPart {
	...
	protected LayoutEditPolicy createLayoutEditPolicy() {
		org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy lep = new org.eclipse.gmf.runtime.diagram.ui.editpolicies.LayoutEditPolicy() {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				...
				switch (AspectualacmeVisualIDRegistry.getVisualID(childView)) {
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof BaseRoleEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((BaseRoleEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof CrosscuttingRoleEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
		...
		if (childEditPart instanceof RoleEditPart) {
			getBorderedFigure().getBorderItemContainer().remove(
					((RoleEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == AspectualacmeElementTypes.Glue_3004) {
				return getChildBySemanticHint(AspectualacmeVisualIDRegistry
