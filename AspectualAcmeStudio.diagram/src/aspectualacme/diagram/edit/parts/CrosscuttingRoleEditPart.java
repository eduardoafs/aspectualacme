...
import aspectualacme.diagram.edit.policies.CrosscuttingRoleItemSemanticEditPolicy;
...
public class CrosscuttingRoleEditPart extends AbstractBorderItemEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new CrosscuttingRoleItemSemanticEditPolicy());
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof aspectualacme.diagram.edit.parts.CrosscuttingRoleEditPart) {
			types.add(AspectualacmeElementTypes.Attachment_4001);
		}
