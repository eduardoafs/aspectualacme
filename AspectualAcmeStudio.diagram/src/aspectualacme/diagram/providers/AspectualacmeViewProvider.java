 ...
 * @generated
 */
public class AspectualacmeViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = AspectualacmeVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = AspectualacmeVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!AspectualacmeElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != AspectualacmeVisualIDRegistry
				...
				if (!SystemEditPart.MODEL_ID
						.equals(AspectualacmeVisualIDRegistry.getModelID(op
								.getContainerView()))) {
		...
		return ConnectorEditPart.VISUAL_ID == visualID
				...
				|| WildCardEditPart.VISUAL_ID == visualID
				|| BaseRoleEditPart.VISUAL_ID == visualID
				|| CrosscuttingRoleEditPart.VISUAL_ID == visualID
				|| GlueEditPart.VISUAL_ID == visualID
				|| RoleEditPart.VISUAL_ID == visualID
				|| PortEditPart.VISUAL_ID == visualID
				|| RepresentationEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = AspectualacmeVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = AspectualacmeVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case ConnectorEditPart.VISUAL_ID:
		...
		case ComponentEditPart.VISUAL_ID:
			return createComponent_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case WildCardEditPart.VISUAL_ID:
			return createWildCard_2003(domainElement, containerView, index,
					persisted, preferencesHint);
		case BaseRoleEditPart.VISUAL_ID:
			return createBaseRole_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case CrosscuttingRoleEditPart.VISUAL_ID:
			return createCrosscuttingRole_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case GlueEditPart.VISUAL_ID:
			return createGlue_3004(domainElement, containerView, index,
					persisted, preferencesHint);
		case RoleEditPart.VISUAL_ID:
			return createRole_3011(domainElement, containerView, index,
					persisted, preferencesHint);
		case PortEditPart.VISUAL_ID:
			return createPort_3005(domainElement, containerView, index,
					persisted, preferencesHint);
		case RepresentationEditPart.VISUAL_ID:
			return createRepresentation_3010(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (AspectualacmeVisualIDRegistry.getVisualID(elementTypeHint)) {
		case Attachment5EditPart.VISUAL_ID:
			return createAttachment_4001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case Attachment6EditPart.VISUAL_ID:
			return createAttachment_4002(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case AttachmentEditPart.VISUAL_ID:
			return createAttachment_4003(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case Attachment2EditPart.VISUAL_ID:
			return createAttachment_4004(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case Attachment3EditPart.VISUAL_ID:
			return createAttachment_4005(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case Attachment4EditPart.VISUAL_ID:
			return createAttachment_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createConnector_2001(EObject domainElement, View containerView,
		...
		node.setType(AspectualacmeVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createWildCard_2003(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		{
			HintedDiagramLinkStyle diagramFacet = NotationFactory.eINSTANCE
					.createHintedDiagramLinkStyle();
			diagramFacet.setHint("WildCardRepresentationAspectualacme"); //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public Node createBaseRole_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createCrosscuttingRole_3002(EObject domainElement,
	 ...
	 * @generated
	 */
	public Node createGlue_3004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
	 ...
	 * @generated
	 */
	public Node createRole_3011(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createPort_3005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
	 ...
	 * @generated
	 */
	public Node createRepresentation_3010(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		{
	 ...
	 * @generated
	 */
	public Edge createAttachment_4001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		...
		edge.setType(AspectualacmeVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createAttachment_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createAttachment_4003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createAttachment_4004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createAttachment_4005(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	 ...
	 * @generated
	 */
	public Edge createAttachment_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
	...
	private void stampShortcut(View containerView, Node target) {
		if (!SystemEditPart.MODEL_ID.equals(AspectualacmeVisualIDRegistry
