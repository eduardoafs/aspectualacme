...
import aspectualacme.diagram.part.AspectualacmeDiagramEditor;
 ...
 * @generated
 */
public class AspectualacmeValidationDecoratorProvider extends AbstractProvider
	 ...
	 * @generated
	 */
	private static final String MARKER_TYPE = AspectualacmeDiagramEditorPlugin.ID
	...
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof AspectualacmeDiagramEditor) {
	...
	public boolean provides(IOperation operation) {
		...
		return view != null
				&& SystemEditPart.MODEL_ID.equals(AspectualacmeVisualIDRegistry
						.getModelID(view));
	}
