 ...
 * @generated
 */
public class AspectualacmeMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = AspectualacmeDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			AspectualacmeDiagramEditorUtil.selectElementsInDiagram(editor,
