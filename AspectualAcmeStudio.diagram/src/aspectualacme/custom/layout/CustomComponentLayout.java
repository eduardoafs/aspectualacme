package aspectualacme.custom.layout;
 ...
 * @author koehnlein
 */
public class CustomComponentLayout extends ConstrainedToolbarLayout {
	private double scaleFactor = 2;

	public CustomComponentLayout() {
	...
	public void layout(IFigure parent) {
		...
		for (int i = 0; i < numChildren; i++) {
			...
			width = Math.max(minWidth,
					Math.min((int) (clientArea.width / scaleFactor), width));
