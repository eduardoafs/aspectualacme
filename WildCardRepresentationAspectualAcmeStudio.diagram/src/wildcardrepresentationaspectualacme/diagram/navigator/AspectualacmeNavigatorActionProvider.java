...
import wildcardrepresentationaspectualacme.diagram.part.AspectualacmeDiagramEditor;
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof AspectualacmeNavigatorItem) {
					selectedElement = ((AspectualacmeNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, AspectualacmeDiagramEditor.ID);
