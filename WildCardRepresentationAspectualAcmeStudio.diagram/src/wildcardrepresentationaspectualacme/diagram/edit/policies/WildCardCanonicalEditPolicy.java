 ...
 * @generated
 */
public class WildCardCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<AspectualacmeNodeDescriptor> childDescriptors = AspectualacmeDiagramUpdater
				.getWildCard_1000SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<AspectualacmeNodeDescriptor> childDescriptors = AspectualacmeDiagramUpdater
				.getWildCard_1000SemanticChildren((View) getHost().getModel());
