 ...
 * @generated
 */
public class ComponentTypeImpl extends ElementImpl implements ComponentType {
	/**
	...
	public EList<Port> getPort() {
		if (port == null) {
			port = new EObjectContainmentEList<Port>(Port.class, this, AspectualacmePackage.COMPONENT_TYPE__PORT);
		}
		return port;
	}
